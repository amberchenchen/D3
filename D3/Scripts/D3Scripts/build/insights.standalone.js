...
var PATH_STROKE_WIDTH = 1;
var SELECTED_PATH_STROKE_WIDTH = 3;
...
Graph.prototype = {
  ...
  render: function() {
    ...
    var link = this.d3Path = this.parent.append("svg:g").selectAll("path")
      .data(force.links())        
      ...
      .on("mouseover", bind(this, this.PathonMouseOver))
      .on("mouseout", bind(this, this.onMouseOut));

    PATHTEXT = this.parent.selectAll(".pathText")
        .data(this.links)
        .attr("class", "pathText")
        .enter().append("text")
        .attr("dx", 100)
        ...
        .text(bind(this, this.setPathText));
    ...
    var node = this.d3Nodes = this.parent.selectAll(".node")
      ...
      .on('dblclick', bind(this, this.onDoubleClick))
      .on('contextmenu', bind(this, this.onCircleRightClick));
    ...
    this.d3TitleNodes = node.append("text")
      ...
      .append("tspan").attr("x", "5").attr("dy", "2em").text("TEST");
    ...
    function dragmove(d, i) {
        ...
        //tickDrag(); // this is the key to make it work together with updating both px,py,x,y on d !
        // alert("dragmove");
    }
  ...
  PathonMouseOver: function (d) {
      ...
      d = {
          text: d.source.text + "," + d.target.text,
      };

      this.showPathTooltip(offset, d);
      this.emit("node:mouseover", d, offset);
  },

  setPathText: function (d) {
  ...
  updatePaths: function() {
    ...
    PATHTEXT.attr("fill", function (e) {
        var yes = function (e) { return self.pathTextFill(e) },
          no = "none";
  ...
  PathTooltip: function (tmpl) {
      this._PathTooltip = new Tooltip({
          template: typeof tmpl == "string" ? tmpl : defaults.tooltipTemplate
      });
  ...
  showPathTooltip: function (offset, d) {
      this._PathTooltip && this._tooltipOn && this._PathTooltip.show(offset, d);
  },
